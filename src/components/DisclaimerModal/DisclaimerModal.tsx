    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the CHKN protocol have made
      ...
      return (
        <div>
          <p>Attention CHKN Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with CHKN is CHKN/yCRV
            (Curve yPool tokens)
          </p>
